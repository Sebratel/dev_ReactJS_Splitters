...
export function AppPageHeader({
  ...
  return (
    <header
      className={cn(
        'relative overflow-hidden rounded-2xl border border-amber-200/70 bg-gradient-to-br from-amber-50 via-white to-amber-50/30 shadow-[0_4px_24px_-8px_rgba(180,83,9,0.18)] ring-1 ring-amber-100/80',
    ...
    >
      ...
      <div className="relative flex flex-col gap-4 px-4 py-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:py-5 xl:px-7">
        <div className="flex min-w-0 flex-1 items-start gap-3 sm:gap-4">
          {Icon ? (
            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-amber-400/25 to-amber-600/10 text-amber-900 shadow-inner ring-1 ring-amber-300/50 sm:h-12 sm:w-12">
