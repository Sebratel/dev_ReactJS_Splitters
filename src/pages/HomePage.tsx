          ...
          <aside className="flex min-h-0 min-w-0 w-full flex-col justify-between gap-3 rounded-2xl border border-white/60 bg-surface-container-lowest/55 p-3.5 shadow-inner shadow-stone-900/[0.03] ring-1 ring-stone-200/50 dark:ring-white/10 backdrop-blur-md sm:gap-4 sm:p-5 lg:max-w-[35rem] lg:justify-self-end">
            {networkCapacityPercent != null ? (
              <div>
                <div className="flex items-end justify-between gap-2">
                  <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-on-surface-variant sm:text-[11px]">
                    Capacidade da rede
                  </p>
                  <span className="text-3xl font-bold tabular-nums tracking-tight text-on-surface sm:text-[2rem]">
            ...
            <div>
              <div className="mb-2 flex items-center justify-between gap-2">
                ...
                <span className="text-[11px] text-on-surface-variant/60">mesmas cores da lista</span>
              </div>
              {(() => {
                ...
                return (
                  <div className="space-y-2">
                    <div className="flex h-3.5 overflow-hidden rounded-full ring-1 ring-stone-200/80 dark:ring-white/10 sm:h-4">
                      <motion.div
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between sm:gap-4">
          <div className="min-w-0">
            ...
            <h2
              ...
              className="mt-1 text-lg font-semibold tracking-tight text-on-surface"
            >
              Incidentes · rede · inventário
            </h2>
            <p className="mt-1 max-w-xl text-[11px] leading-snug text-on-surface-variant sm:text-[12px]">
          ...
          <div className="overflow-hidden rounded-3xl border border-stone-200/70 dark:border-white/10 bg-surface-container-lowest/90 shadow-[0_12px_48px_-24px_rgba(15,23,42,0.18)] ring-1 ring-white/70 backdrop-blur-sm">
              <header className="flex flex-col gap-2 border-b border-stone-100/90 dark:border-white/5 bg-gradient-to-r from-stone-50/80 dark:from-white/5 to-white dark:to-surface-container-lowest p-4 md:flex-row md:items-center md:justify-between md:py-3.5 md:pl-5 md:pr-4">
                <div className="min-w-0 space-y-1">
                  ...
                  <h2 className="text-lg font-semibold tracking-tight text-on-surface md:text-xl">
                    Massivas abertas
                  </h2>
                  <p className="max-w-xl text-[12px] leading-snug text-on-surface-variant sm:text-[13px]">
                ...
                {recentMassivas.length > 0 ? (
                  recentMassivas.map((ticket, ti) => (
                    <motion.article
                      ...
                      className="group rounded-2xl px-3 py-3 transition-[background] hover:bg-amber-50/40 dark:hover:bg-amber-950/40 md:px-4"
                    >
                      <div className="mx-auto flex max-w-3xl flex-col gap-3 sm:flex-row sm:items-start sm:justify-between sm:gap-4">
                        <div className="flex min-w-0 gap-3 sm:gap-3.5">
                          ...
                          <div className="min-w-0 space-y-2">
                            <p className="text-[15px] font-semibold leading-snug text-on-surface sm:text-base">
                              {ticket.title}
                            </p>
                            <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[12px] text-on-surface-variant">
                              <span className="font-mono tabular-nums text-on-surface-variant">
                                <span className="font-sans font-medium text-on-surface-variant">Protocolo </span>
                                {ticket.protocol > 0 ? ticket.protocol : '—'}
                              </span>
                              <span className="hidden text-on-surface-variant/60 sm:inline" aria-hidden>
                                ·
                              </span>
                              <span>
                                <span className="font-medium text-on-surface-variant">Clientes </span>
                        ...
                        <div className="flex shrink-0 flex-col items-start gap-1.5 sm:items-end sm:pl-2">
                          ...
                          <p className="flex flex-wrap items-baseline justify-start gap-x-1.5 text-[11px] sm:justify-end">
                            <span className="font-medium text-on-surface-variant">Previsão de encerramento</span>
                            <span className="text-stone-300" aria-hidden>
                              ·
                            </span>
                            <time
                              className="font-medium tabular-nums text-on-surface-variant"
                              dateTime={
