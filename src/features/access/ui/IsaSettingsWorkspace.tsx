    ...
    <div className="space-y-4 pb-16">
      <div className="grid grid-cols-1 gap-3 xl:grid-cols-4">
        <div className="rounded-2xl border border-neutral-200/90 bg-white p-4 shadow-sm">
          <p className="text-[11px] font-bold uppercase tracking-wide text-neutral-500">Origem ativa</p>
          <div className="mt-2 flex items-center gap-2 text-sm font-semibold text-neutral-900">
            <Database className="size-4 text-amber-700" aria-hidden />
            {sourceLabel(config.source)}
          </div>
        </div>

        <div className="rounded-2xl border border-neutral-200/90 bg-white p-4 shadow-sm">
          <p className="text-[11px] font-bold uppercase tracking-wide text-neutral-500">Versão</p>
        ...
        <div className="rounded-2xl border border-neutral-200/90 bg-white p-4 shadow-sm">
          <p className="text-[11px] font-bold uppercase tracking-wide text-neutral-500">Última atualização</p>
          <p className="mt-2 text-sm font-semibold text-neutral-900">{formatDateTime(config.updatedAt)}</p>
        </div>

        <div className="rounded-2xl border border-neutral-200/90 bg-white p-4 shadow-sm">
          <p className="text-[11px] font-bold uppercase tracking-wide text-neutral-500">Responsável</p>
          <p className="mt-2 text-sm font-semibold text-neutral-900">
      ...
      <div className="rounded-2xl border border-amber-200/70 bg-amber-50/80 p-4 text-sm text-amber-950 shadow-sm">
      ...
      <div className="flex flex-wrap items-center gap-3 rounded-2xl border border-neutral-200/90 bg-white px-4 py-3 shadow-sm">
        <span
          className={cn(
        ...
        <button
          ...
          disabled={busy}
          className="inline-flex min-h-[44px] items-center gap-2 rounded-xl border border-neutral-200 bg-white px-4 py-2.5 text-sm font-semibold text-neutral-800 shadow-sm transition hover:bg-neutral-50 disabled:cursor-not-allowed disabled:opacity-60"
        >
        ...
        <button
          ...
          disabled={!dirty || busy}
          className="inline-flex min-h-[44px] items-center gap-2 rounded-xl border border-neutral-200 bg-white px-4 py-2.5 text-sm font-semibold text-neutral-700 transition hover:bg-neutral-50 disabled:cursor-not-allowed disabled:opacity-60"
        >
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="space-y-1">
                    <h2 className="text-base font-semibold text-neutral-900">{section.label}</h2>
                    {section.description ? (
                      <p className="text-sm text-neutral-600">{section.description}</p>
                    ) : null}
                  </div>
                  <span className="rounded-full bg-neutral-100 px-2.5 py-1 text-[11px] font-bold uppercase tracking-wide text-neutral-600">
                    {value.length} chars
                  </span>
                </div>
                ...
                <textarea
                  ...
                  spellCheck={false}
                  className="mt-3 w-full rounded-2xl border border-neutral-200 bg-neutral-50/70 px-4 py-3 text-sm leading-6 text-neutral-900 shadow-inner outline-none transition focus:border-amber-400 focus:bg-white focus:ring-2 focus:ring-amber-500/20"
                />

                <details className="mt-3 rounded-xl border border-dashed border-neutral-200 bg-neutral-50/70 px-3 py-2">
                  ...
                  <pre className="mt-3 overflow-x-auto whitespace-pre-wrap break-words text-xs leading-6 text-neutral-700">
        ...
        <aside className="space-y-4 xl:sticky xl:top-6 xl:self-start">
          <div className="rounded-2xl border border-neutral-200/90 bg-white p-4 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-base font-semibold text-neutral-900">Preview do prompt final</h2>
            </div>
            <p className="mt-1 text-sm text-neutral-600">
              Prévia montada com os blocos acima e a instrução fixa de formato JSON.
            </p>
            <pre className="mt-4 max-h-[70vh] overflow-auto rounded-2xl border border-neutral-200 bg-neutral-950 px-4 py-4 text-xs leading-6 text-neutral-100 whitespace-pre-wrap break-words">
              {previewPrompt}
            </pre>
          </div>
        </aside>
