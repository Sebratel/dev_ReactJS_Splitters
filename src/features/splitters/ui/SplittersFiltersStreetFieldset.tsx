  ...
  return (
    <fieldset className="mt-4 min-w-0">
      ...
      {streetOptions.length > 0 ? (
        <ul
          className="mt-2 max-h-52 space-y-2 overflow-y-auto rounded-lg border border-neutral-200 p-2 dark:border-neutral-600"
          role="group"
            ...
            return (
              <li key={line}>
                <label className="flex cursor-pointer items-start gap-2 text-sm">
                  <input
                    type="checkbox"
                    className="mt-0.5 rounded border-neutral-300 text-violet-600 focus:ring-violet-500 dark:border-neutral-600"
                    checked={checked}
